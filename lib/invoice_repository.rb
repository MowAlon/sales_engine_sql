...
class InvoiceRepository < Repository
  ...
  def create(invoice_info)
    ...
    engine.db.execute "INSERT INTO invoices(customer_id,merchant_id,status,created_at,updated_at) VALUES (?,?,?,?,?);", [customer_id,merchant_id,status,created_at,updated_at]
